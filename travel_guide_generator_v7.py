#!/usr/bin/env python3
"""
旅行攻略生成器 V7 - A4精确设计 + 真实小红书攻略
严格按照A4尺寸，高密度布局，半透明背景图，左下角装饰图片
"""
...
class TravelGuideGeneratorV7:
    """旅行攻略生成器 V7 - A4精确设计"""

    def __init__(self, output_dir: str = "./travel_guides_v7"):
    ...
    SAMPLE_GUIDES = [
        {
            ...
            "language": "汉语",
            "currency": "人民币（RMB）",
            "tags": ["大理", "丽江", "香格里拉", "洱海", "雪山"],
            "days_detail": [
                {"day": "D1-2", "title": "大理｜风花雪月", "spots": "洱海·双廊古镇·喜洲古镇·崇圣寺三塔·小普陀", "time": "2天", "tips": "租电瓶车环湖全程130公里，建议早上出发。洱海骑行最美路段是龙龛码头到双廊。喜洲粑粑必尝外酥内嫩！双廊海景房推窗见海，拍照绝美。"},
                {"day": "D3-4", "title": "丽江｜古城韵味", "spots": "丽江古城·束河古镇·玉龙雪山·蓝月谷·白沙古镇", "time": "2天", "tips": "玉龙雪山需提前订票，建议住古城方便逛街。蓝月谷拍照最佳时间上午10-11点。束河古镇比丽江更安静，商业化少。"},
                {"day": "D5-7", "title": "香格里拉｜高原秘境", "spots": "普达措公园·松赞林寺·纳帕海·独克宗古城·白水台", "time": "3天", "tips": "海拔3300米，注意高反，提前准备氧气瓶。松赞林寺是小布达拉宫。普达措最美季节6-8月。独克宗古城晚上的古城墙拍照很美。"},
            ],
            "hotels": [
            ...
            "foods": [
                {"name": "喜洲粑粑", "price": "10元", "feature": "外酥内嫩，传统白族小吃", "must_try": True},
                {"name": "酸辣鱼", "price": "68元", "feature": "酸辣开胃，洱海特色", "must_try": True},
                {"name": "铜锅洋芋饭", "price": "25元", "feature": "香糯可口，特色主食", "must_try": True},
                {"name": "白族三道茶", "price": "38元", "feature": "一苦二甜三回味", "must_try": True},
                {"name": "丽江粑粑", "price": "8元", "feature": "油而不腻，外酥里嫩", "must_try": True},
                {"name": "牦牛火锅", "price": "88元", "feature": "高原特色，肉质鲜嫩", "must_try": True},
                {"name": "酥油茶", "price": "15元", "feature": "藏族特色，补充能量", "must_try": False},
                {"name": "青稞酒", "price": "20元", "feature": "藏族传统酒类", "must_try": False},
            ],
            "photos": [
        ...
        },
        {
            ...
            "tags": ["京都", "樱花", "红叶", "寺庙", "和服"],
            "days_detail": [
                {"day": "D1", "title": "伏见稻荷+清水寺", "spots": "伏见稻荷大社·清水寺·二年坂三年坂·八坂神社", "time": "1天", "tips": "伏见稻荷7点前去避开人流，清水寺可体验和服。千本鸟居最美在半山腰。二年坂三年坂逛吃逛喝，很多特色小店，推荐买伴手礼。"},
                {"day": "D2", "title": "岚山+金阁寺", "spots": "岚山竹林·金阁寺·天龙寺·渡月桥", "time": "1天", "tips": "岚山竹林早晨最美，金阁寺晴天拍照效果佳。岚山小火车推荐坐到龟山公园。天龙寺枯山水值得看，禅意十足。渡月桥是赏樱名所，春天必去。"},
                {"day": "D3", "title": "奈良+大阪", "spots": "奈良公园·东大寺·春日大社·道顿堀·黑门市场", "time": "1天", "tips": "鹿仙贝150日元，小心小鹿很贪吃！东大寺世界最大木造建筑，必看。大阪道顿堀是美食天堂，章鱼烧、大阪烧必尝。黑门市场海鲜新鲜，上午去最好。"},
                {"day": "D4", "title": "祇园+二条城", "spots": "祇园·八坂神社·二条城·锦市场", "time": "1天", "tips": "傍晚可能有艺伎出没，但请勿拍照。二条城是德川家康的居城，必看。锦市场被称为'京都的厨房'，可品尝各种小吃，章鱼烧、玉子烧必尝。"},
                {"day": "D5", "title": "锦市场+返程", "spots": "锦市场·京都站", "time": "半天", "tips": "锦市场可品尝各种小吃，章鱼烧、玉子烧必尝。京都站购物方便，很多伴手礼。京都站伊势丹是购物天堂，必买伴手礼。"},
            ],
            "hotels": [
            ...
            "foods": [
                {"name": "怀石料理", "price": "300-800元", "feature": "精致日式，一菜一味", "must_try": True},
                {"name": "抹茶甜点", "price": "30-60元", "feature": "宇治抹茶，口感细腻", "must_try": True},
                {"name": "章鱼烧", "price": "25元", "feature": "大阪特色，外酥里嫩", "must_try": True},
                {"name": "一兰拉面", "price": "45元", "feature": "拉面连锁，品质稳定", "must_try": False},
                {"name": "寿司", "price": "80-200元", "feature": "新鲜海产，传统日式", "must_try": True},
                {"name": "天妇罗", "price": "60-120元", "feature": "酥脆口感，油炸食品", "must_try": True},
                {"name": "玉子烧", "price": "15元", "feature": "甜蛋卷，京都特色", "must_try": True},
                {"name": "关东煮", "price": "35元", "feature": "煮物，暖胃美食", "must_try": False},
            ],
            "photos": [
        ...
        },
        {
            ...
            "tags": ["新疆", "自驾", "雪山", "草原", "沙漠"],
            "days_detail": [
                {"day": "D1-12", "title": "北疆环线", "spots": "乌鲁木齐·布尔津·喀纳斯·禾木·魔鬼城·克拉玛依", "time": "12天", "tips": "喀纳斯三湾必看（神仙湾、月亮湾、卧龙湾），禾木看日出日落。布尔津是进入喀纳斯的门户，可在此休整。魔鬼城风蚀地貌，日落时分最美。禾木的图瓦人小木屋是特色，清晨的炊烟很美。"},
                {"day": "D13-20", "title": "独库公路", "spots": "克拉玛依·赛里木湖·那拉提·巴音布鲁克·库车", "time": "8天", "tips": "一日四季，最高点哈希勒根达坂海拔3400米，注意高反。赛里木湖大西洋最后一滴眼泪，湖边露营看星空，银河清晰可见。那拉提草原6月最美，野花盛开。巴音布鲁克九曲十八弯日落绝美。"},
                {"day": "D21-30", "title": "南疆人文", "spots": "库车·喀什·帕米尔高原·塔县·返回乌鲁木齐", "time": "10天", "tips": "喀什老城活着的千年古城，帕米尔高原世界屋脊。白沙湖湖面如镜，卡拉库里湖慕士塔格峰倒影。塔县石头城遗址值得一看。盘龙古道是古丝绸之路，历史厚重。"},
            ],
            "hotels": [
            ...
            "foods": [
                {"name": "大盘鸡", "price": "88元", "feature": "沙湾最正宗，鸡肉入味", "must_try": True},
                {"name": "手抓饭", "price": "45元", "feature": "和田最地道，羊肉香", "must_try": True},
                {"name": "烤包子", "price": "8元", "feature": "喀什街头，皮脆肉嫩", "must_try": True},
                {"name": "烤全羊", "price": "388元", "feature": "那拉提草原，仪式感", "must_try": True},
                {"name": "酸奶疙瘩", "price": "15元", "feature": "自制，酸甜开胃", "must_try": True},
                {"name": "馕", "price": "3元", "feature": "主食必备，可保存", "must_try": True},
                {"name": "油塔子", "price": "18元", "feature": "新疆特色，层层酥脆", "must_try": True},
                {"name": "烤羊肉串", "price": "12元/串", "feature": "新疆夜市，必吃", "must_try": True},
            ],
            "photos": [
        ...
        },
        {
            ...
            "language": "汉语、四川话",
            "currency": "人民币（RMB）",
            "tags": ["成都", "熊猫", "火锅", "宽窄巷子", "慢生活"],
            "days_detail": [
                {"day": "D1", "title": "熊猫基地+春熙路", "spots": "大熊猫基地·春熙路·IFS太古里", "time": "1天", "tips": "熊猫8:00-10:00最活跃，春熙路网红小酒馆打卡。IFS爬墙熊猫必打卡，太古里逛吃逛喝。春熙路是成都最繁华的商圈，购物方便。"},
                {"day": "D2", "title": "宽窄巷子+武侯祠", "spots": "宽窄巷子·武侯祠·锦里", "time": "1天", "tips": "锦里18:30后灯笼亮起最美，小吃一条街。武侯祠三国文化，必看。宽窄巷子老成都体验，窄巷文艺小店多。宽巷子是老成都的体验，窄巷子是小资情调。"},
                {"day": "D3", "title": "青城山+都江堰", "spots": "青城山·都江堰", "time": "1天", "tips": "青城山索道上山步行下山，都江堰16:00看夕阳。青城山道教名山，前山景点多。都江堰古代水利工程奇迹，必看。青城后山更清幽，人少景美。"},
                {"day": "D4", "title": "杜甫草堂+人民公园", "spots": "杜甫草堂·人民公园", "time": "半天", "tips": "人民公园鹤鸣茶社百年老茶馆，体验慢生活。杜甫草堂幽静雅致，适合慢游。鹤鸣茶社是成都茶文化的代表，15-30元/杯，坐一下午都可以。"},
            ],
            "hotels": [
            ...
            "foods": [
                {"name": "火锅（蜀九香）", "price": "80-120元/人", "feature": "本地人最爱，麻辣鲜香", "must_try": True},
                {"name": "兔头", "price": "15元/个", "feature": "双流老妈兔头，麻辣入味", "must_try": True},
                {"name": "冒菜", "price": "35元", "feature": "冒椒火辣，香辣过瘾", "must_try": True},
                {"name": "冰粉", "price": "8元", "feature": "玫瑰冰粉，清凉解暑", "must_try": True},
                {"name": "钟水饺", "price": "18元", "feature": "老字号，甜红油辣", "must_try": True},
                {"name": "甜水面", "price": "12元", "feature": "甜辣口味，特色小吃", "must_try": True},
                {"name": "担担面", "price": "15元", "feature": "麻辣面条，传统美食", "must_try": True},
                {"name": "麻婆豆腐", "price": "28元", "feature": "川菜经典，麻婆豆腐", "must_try": True},
            ],
            "photos": [
        ...
        },
        {
            ...
            "best_time": "11-2月（雨季后）",
            "budget": "3000-5000元",
            "transport": "落地签2000泰铢，Grab打车方便",
            "visa": "落地签2000泰铢 / 电子签证300泰铢",
            "timezone": "GMT+7",
            "weather": "25-35°C",
            "language": "泰语、英语",
            "currency": "泰铢（THB），1元≈5泰铢",
            "tags": ["清迈", "寺庙", "夜市", "大象", "慢生活"],
            "days_detail": [
                {"day": "D1", "title": "古城寺庙巡礼", "spots": "契迪龙寺·帕辛寺·周日夜市", "time": "1天", "tips": "周日夜市17:00-22:00，必买手工工艺品。契迪龙寺宏大的古寺遗址，拍照出片。帕辛寺兰纳风格建筑，金碧辉煌。古城墙骑行一周，很有感觉。"},
                {"day": "D2", "title": "双龙寺+宁曼路", "spots": "双龙寺·宁曼路·咖啡馆", "time": "1天", "tips": "双龙寺16:00看日落，俯瞰清迈全景。宁曼路文艺街区，咖啡馆和设计店聚集。Ristr8to世界级拉花咖啡，必试。Cheevit Cheeva网红Bingsu，推荐。"},
                {"day": "D3", "title": "大象营+SPA", "spots": "Patara大象营·泰式SPA", "time": "1天", "tips": "大象营6000泰铢/人，保护式体验不骑大象。泰式SPA推荐Lila Thai Massage，由前囚犯提供培训就业。SPA很便宜，500-1500泰铢/小时。"},
                {"day": "D4", "title": "湄平河+瓦洛洛", "spots": "湄平河·瓦洛洛市场", "time": "1天", "tips": "瓦洛洛市场本地人市场，物价便宜。湄平河The Good View河边晚餐，人均300-500泰铢，日落时分最美。湄平河游船体验，推荐傍晚。"},
                {"day": "D5", "title": "古城悠闲+返程", "spots": "塔佩门·古城墙·咖啡馆", "time": "半天", "tips": "塔佩门喂鸽子，古城墙骑行一周。古城咖啡馆发呆，体验慢生活。推荐The Baristro咖啡馆，环境好咖啡香。清迈机场免税店购物方便。"},
            ],
            "hotels": [
            ...
            "foods": [
                {"name": "Khao Soi泰北咖喱面", "price": "25元", "feature": "泰北特色，香辣", "must_try": True},
                {"name": "芒果糯米饭", "price": "12元", "feature": "甜品经典，甜糯", "must_try": True},
                {"name": "泰式炒河粉", "price": "12元", "feature": "街头小吃，经典", "must_try": True},
                {"name": "椰子冰淇淋", "price": "10元", "feature": "清凉解暑，甜品", "must_try": True},
                {"name": "泰式奶茶", "price": "8元", "feature": "橙色奶茶，特色", "must_try": True},
                {"name": "烤肉串", "price": "3元/串", "feature": "夜市必吃，便宜", "must_try": True},
                {"name": "泰式炒饭", "price": "15元", "feature": "街头小吃，简单", "must_try": False},
                {"name": "春卷", "price": "5元", "feature": "街头小吃，脆口", "must_try": True},
            ],
            "photos": [
            ...
            "essentials": ["防晒霜", "驱蚊液", "清凉油", "轻便夏装", "人字拖", "充电宝", "护照复印件", "现金泰铢"],
    ...
    def get_images(self, location):
        images = self.IMAGE_MAPPINGS.get(location, {
            "hero": self.IMAGE_MAPPINGS["封面"],
            "corner1": self.IMAGE_MAPPINGS["封面"],
            "corner2": self.IMAGE_MAPPINGS["封面"],
        })
        return images
...
"""
        ...
        for i, guide in enumerate(self.guides, 1):
            ...
            for hotel in guide['hotels']:
                hotels_html += f"""
                    ...
                    <div class="info-item" style="font-size: 8px; color: #7F8C8D; padding-left: 3px;">
                        {hotel['feature']}
                    </div>
                """
        ...
        <div class="guide-page">
            <div class="guide-header">
                <div class="guide-header-bg" style="background-image: url('{images['hero']}')"></div>
            ...
            <div class="corner-images">
                <img src="{images['corner1']}" alt="风景1" onerror="this.style.display='none'">
                <img src="{images['corner2']}" alt="风景2" onerror="this.style.display='none'">
            </div>
        </div>
"""
...
async def main():
    generator = TravelGuideGeneratorV7()
