...
class TravelGuideGeneratorV8:
    """旅行攻略生成器 V8 - 调整布局"""

    def __init__(self, output_dir: str = "./travel_guides_v8"):
    ...
    SAMPLE_GUIDES = [
        ...
        },
        {
            ...
            "days_detail": [
                ...
                {"day": "D3", "title": "奈良+大阪", "spots": "奈良公园·东大寺·春日大社·道顿堀·黑门市场", "time": "1天", "tips": "鹿仙贝150日元，小心小鹿很贪吃！东大寺世界最大木造建筑，必看。大阪道顿堀是美食天堂，章鱼烧、大阪烧必尝"},
        ...
        },
        {
            ...
            "days_detail": [
                ...
                {"day": "D13-20", "title": "独库公路", "spots": "克拉玛依·赛里木湖·那拉提·巴音布鲁克·库车", "time": "8天", "tips": "一日四季，最高点哈希勒根达坂海拔3400米，注意高反。赛里木湖大西洋最后一滴眼泪，湖边露营看星空，银河清晰可见。那拉提草原6月最美"},
        ...
        <div class="guide-page">
            ...
            <div class="guide-content">
                ...
                <div class="col">
                    ...
                    <div class="col-header" style="margin-top: 12px;">
                        <h4>🎒 必备物品</h4>
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="col-header" style="margin-top: 8px;">
                        <h4>🍜 美食清单</h4>
                    </div>
                    <div class="info-block" style="flex: 0;">
                        {foods_html}
                    ...
                    <div class="info-block" style="flex: 1; overflow-y: auto;">
                        {photos_html}
                    </div>
                </div>
            </div>
...
"""
    ...
    async def generate(self, export_pdf=True):
        print("🚀 开始生成旅行攻略 V8（调整布局：贴士+必备在左边）...")
...
async def main():
    generator = TravelGuideGeneratorV8()
