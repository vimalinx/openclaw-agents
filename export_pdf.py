...
async def export_pdf_with_images(html_path: Path, pdf_path: Path):
    ...
    async with async_playwright() as p:
        ...
        print("🌐 加载HTML...")
        await page.goto(f"file://{html_path.absolute()}", wait_until="domcontentloaded")
...
if __name__ == "__main__":
    html_path = Path("travel_guides_v6/travel_guides.html")
    pdf_path = Path("travel_guides_v6/travel_guides.pdf")
